...
const schemaSql = `-- Supabase Table Schema Setup for YouTuber Website
...
// Also write to a file in the workspace for easy reference
const sqlFilePath = path.join(__dirname, 'supabase_schema.sql');
fs.writeFileSync(sqlFilePath, schemaSql);
console.log(`Saved SQL schema to ${sqlFilePath}`);
